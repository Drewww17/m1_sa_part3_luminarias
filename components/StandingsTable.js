          ...
          {data.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Name */}
                <td className="py-4 px-4">
                  <div className="font-bold text-base group-hover:text-[#ccff00] transition-colors">
                    {name}
                  </div>
                </td>
                ...
                <td className="py-4 px-4 text-right">
                  <motion.div
                    className="text-xl font-mono font-bold group-hover:text-[#ccff00] transition-colors"
