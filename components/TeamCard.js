    ...
    >
      ...
      <div className="relative p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          {wins > 0 && (
            <motion.div
              className="px-3 py-1 rounded-full bg-[#00D2BE]/20 border border-[#00D2BE]/50"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
        ...
        <div className="flex items-center justify-center mb-4">
          ...
          />
          <div className="w-20 h-20 rounded-lg bg-zinc-800 flex items-center justify-center border-2 border-[#00D2BE]/30" style={{ display: 'none' }}>
        ...
        <div className="flex items-end justify-between">
          <div>
            ...
            <motion.div
              className="text-4xl font-black font-mono group-hover:text-[#00D2BE] transition-colors"
          ...
          {/* Arrow Indicator */}
          <motion.div
            className="w-8 h-8 rounded-full bg-[#00D2BE]/10 flex items-center justify-center"
            whileHover={{ x: 5 }}
          >
            <svg
              className="w-4 h-4 text-[#00D2BE]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
